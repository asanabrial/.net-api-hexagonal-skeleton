...
public class GetAllUsersManagementQueryHandlerTest
{
    ...
    {
        // Arrange
        var query = new GetAllUsersManagementQuery(pageNumber: 1, pageSize: 10, searchTerm: "   "); // Empty/whitespace
        var cancellationToken = CancellationToken.None;
    ...
    public async Task Handle_SearchByPhone_ShouldWork()
    {
        ...
        var query = new GetAllUsersManagementQuery(pageNumber: 1, pageSize: 10, searchTerm: phoneNumber);
        var cancellationToken = CancellationToken.None;
    ...
    public async Task Handle_SearchByEmail_ShouldWork()
    {
        ...
        var query = new GetAllUsersManagementQuery(pageNumber: 1, pageSize: 10, searchTerm: email);
        var cancellationToken = CancellationToken.None;
