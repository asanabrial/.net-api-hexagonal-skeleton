...
namespace HexagonalSkeleton.Application.Query
{
    ...
    /// Follows CQRS, Clean Architecture, and SOLID principles
        ...
        : IRequestHandler<GetAllUsersQuery, PagedQueryResult<UserDto>>
    {
        ...
        /// </summary>
        private async Task ValidateRequestAsync(GetAllUsersQuery request, CancellationToken cancellationToken)
        {
        ...
        private PagedQueryResult<UserDto> MapToResult(Domain.ValueObjects.PagedResult<Domain.User> pagedDomainResult)
        {
            ...
            return PagedQueryResult<UserDto>.FromDomain<Domain.User>(pagedDomainResult, userDtos);
        }
    }
}
